...
A modern and responsive To-Do List Dashboard built using HTML & CSS. The project includes a clean dashboard layout, task categories, sidebar navigation, and a UI inspired by modern admin panels.
